...
def test_handle_events_player_movement(mock_state_manager):
    with mock.patch("devscape.main.pygame") as _:
        with mock.patch("devscape.main.StateManager", return_value=mock_state_manager):
            ...
            with mock.patch("devscape.main.pygame.event.get", return_value=[event_down]):
                game.handle_events()
                mock_state_manager.player_manager.move_player.assert_called_with(0, 1)
            ...
            with mock.patch("devscape.main.pygame.event.get", return_value=[event_left]):
                game.handle_events()
            ...
            with mock.patch("devscape.main.pygame.event.get", return_value=[event_right]):
                game.handle_events()
                mock_state_manager.player_manager.move_player.assert_called_with(1, 0)
...
def test_show_chat_bubble_and_expire(mock_state_manager):
    with mock.patch("devscape.main.pygame") as _:
        ...
        with mock.patch("devscape.main.StateManager", return_value=mock_state_manager):
            ...
            with mock.patch.object(_.time, "get_ticks", return_value=mock_entity.bubble_expires + 1):
...
def test_send_player_message_success(mock_state_manager):
    with mock.patch("devscape.main.pygame") as _:
        with mock.patch("devscape.main.StateManager", return_value=mock_state_manager):
            ...
            game.state_manager.get_game_state.return_value.entities.get.return_value = mock_llm_character

            with mock.patch.object(game.ollama_client, 'send_message', return_value="AI Reply") as mock_send_message:
                with mock.patch.object(game, 'show_chat_bubble') as mock_show_chat_bubble:
                    ...
                    mock_show_chat_bubble.assert_any_call(mock_llm_character, "AI Reply")